		...
		<>
			...
			<section id="about" className="section-hero-2 position-relative pt-130 pb-3">
							...
							<div className="row align-items-end py-60">
								<div className="col-lg-5 ps-lg-5 text-lg-start text-center">
									<div className="position-relative mb-lg-0 mb-5">
										<img src="assets/imgs/home-page-2/hero-1/people.png" alt="erfanalin" />
										<div className="position-absolute end-0 top-100 translate-middle-y icon-decorate">
											<img src="assets/imgs/home-page-2/hero-1/icon.svg" alt="erfanalin" />
										</div>
									</div>
								</div>
										...
										<div className="text-secondary-2 d-flex align-items-center">
											...
											<div className="text-dark">
												<div className="typewriter">
													<h1 className="fs-6 fw-medium">Hey, I’m Erfan</h1>
												</div>
											</div>
											&lt;/span&gt;
										</div>
										<h1 className="fs-50 my-3">Freelance <span className="text-linear-4">{'{'}Full Stack{'}'}</span>Web &amp; App developer<span className="flicker">_</span></h1>
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">With expertise in cutting-edge technologies such as</span> <span className="text-secondary-2">Next.JS</span>, <span className="text-secondary-2">React</span>, <span className="text-secondary-2">Wordpress</span>, and <span className="text-secondary-2">Node.Js</span><span className="text-dark">... Whether it's a portfolio, business site, or full-stack application — I create fast, responsive, and scalable digital experiences.</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
				...
				<div className="background position-absolute top-0 start-0 w-100 h-100">
					<img className="bg-w" src="assets/imgs/home-page-2/hero-1/bg.png" alt="erfanalin" />
					<img className="bg-d" src="assets/imgs/home-page-2/hero-1/bg-dark.png" alt="erfanalin" />
				</div>
			</section>
